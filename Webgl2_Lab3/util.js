...
var matrix4X4 = {   
    perspective : function(view_frustum_object)
    {
        //*/
        return [
            view_frustum_object.f/view_frustum_object.aspect, 0, 0, 0,
            0, view_frustum_object.f, 0, 0,
            0, 0, (view_frustum_object.near + view_frustum_object.far)*view_frustum_object.rangeInverse,-1.0,
            0, 0, view_frustum_object.near*view_frustum_object.far*view_frustum_object.rangeInverse*(2), 0
        ];
    },
    projection: function(width, height, depth, fudgeFactor) 
    {
